...
if not data_df.empty:
    ...
    incomplete_records_df = data_df[
        ( (data_df['RMA'].astype(str).str.strip().str.lower() == 'n/a') | (data_df['RMA'].astype(str).str.strip() == '') ) |
        ( (data_df['S/N'].astype(str).str.strip().str.lower() == 'n/a') | (data_df['S/N'].astype(str).str.strip() == '') )
    ].copy()
